...
ActiveRecord::Schema.define(:version => 20140217090720) do
  ...
  create_table "comments", :force => true do |t|
    ...
    t.string   "ancestry"
    t.integer  "parent_id"
    t.boolean  "st_profile",       :default => false
  end
  ...
  create_table "lesson_checkouts", :force => true do |t|
    t.integer  "user_id"
    t.integer  "video_id"
  ...
  create_table "student_teacher_profiles", :force => true do |t|
    t.integer  "user_id"
  ...
  add_index "student_teacher_profiles", ["user_id"], :name => "index_student_teacher_profiles_on_user_id"
  ...
  create_table "videos", :force => true do |t|
    ...
    t.boolean  "processed"
    t.string   "lesson_upload"
    t.string   "lesson_upload_file_name"
    t.string   "lesson_upload_content_type"
    t.integer  "lesson_upload_file_size"
    t.datetime "lesson_upload_updated_at"
    t.string   "price"
    t.string   "is_active"
  end
